...
reg  [7:0]  q_rxdp_x8, q_rxdn_x8, q_rxdp_x8_sclk, q_rxdn_x8_sclk, q_nrzi_data, q_nrzi_data2, q_smark;
...
assign w_smark = (state==IDLE_STATE) ? 'd0 : { &{~w_data_19[18],w_data_19[17:12]}
...
//`endif
  ...
  wire SPEED_MODE;
  assign  SPEED_MODE = (utmi_xcvrselect_i[1] == 1'b0);//Full Spedd or High Speed, only support full speed
