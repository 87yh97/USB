...
assign utmi_txready_o   = utmi_xcvrselect_i ? fs_txready_o   : hs_txready_o  ;
assign utmi_data_in_o   = utmi_xcvrselect_i ? fs_data_in_o   : hs_data_in_o  ;
assign utmi_rxvalid_o   = utmi_xcvrselect_i ? fs_rxvalid_o   : hs_rxvalid_o  ;
assign utmi_rxactive_o  = utmi_xcvrselect_i ? fs_rxactive_o  : hs_rxactive_o ;
assign utmi_rxerror_o   = utmi_xcvrselect_i ? fs_rxerror_o   : hs_rxerror_o  ;
assign utmi_linestate_o = utmi_xcvrselect_i ? fs_linestate_o : hs_linestate_o;
...
`getname(usb2_0_softphy,`module_name)
    ...
    (
        ...
        ,.TxValid_i        (utmi_txvalid_i&(!utmi_xcvrselect_i))
...
(
    ...
    ,.utmi_txvalid_i    (utmi_txvalid_i&(utmi_xcvrselect_i))
