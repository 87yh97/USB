...
(
    ...
    reg  [3:0] cur_state /* synthesis syn_keep=1 */;
    reg  [3:0] next_state /* synthesis syn_keep=1 */;
...
(
    ...
    reg [15:0] s_state /* synthesis syn_keep=1 */;
    wire s_active;
    ...
    localparam wait_timeout_hs = 16'b0000000001111111;
